...
Kallisto() {
      ...
      filename=$1
      mkdir Simulation/Kallisto_real_results
      mkdir Simulation/Kallisto_real_results/$filename

      ./Simulation/kallisto_linux-v0.43.1/kallisto quant -i Simulation/indices/Kallisto/transcripts.idx --threads=8 --output-dir=Simulation/Kallisto_real_results/$filename --single -l 1600 -s 50 Dropseq_Alignment_Cookbook/demultiplexed_fastqs/$1'.fastq'
