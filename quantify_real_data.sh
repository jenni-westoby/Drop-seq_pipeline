...
Kallisto() {
      ...
      ./Simulation/kallisto_linux-v0.43.1/kallisto quant -i Simulation/indices/Kallisto/transcripts.idx --threads=8 --output-dir=Simulation/Kallisto_real_results/$filename Dropseq_Alignment_Cookbook/demultiplexed_fastqs/$1'.fastq'
