...
save(dropseq_scater_QC, file="Benchmarking_paper/processed_files/data/SupplementaryFigure14_scater_object.RData")
...
write.table(QC_sim, file = "Benchmarking_paper/processed_files/data/SupplementaryFigure14_reads_alignment_data.txt")